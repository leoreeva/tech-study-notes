...
Sources:
- [Excel Data Visualization Course – Guide to Charts & Dashboards](https://www.youtube.com/watch?v=VV8iRJ-DS0A)
- [Data Visualization Course | Data Visualization Tutorial | Data Visualization Explained | Simplilearn](https://www.youtube.com/watch?v=7kPqESo1vRw)
...
### 10. Box and Whisker Charts (Box Plots)
...
| Show composition/proportion | Pie, Donut, Stacked Column/Bar |
| Show distribution | Histogram, Box Plot |
| Show relationships | Scatter Plot |
| Show hierarchy | Tree Map |
| Show geographic data | Map Chart |
| Statistical summary | Box and Whisker |
| Multi-variable comparison | Radar Chart |
| Pattern identification | Heat Map |
