...
[[Original source](https://garrettmickley.com/sockpuppet-account-creation/)]

Sockpuppet account creation, just like OSINT, is always changing.
...
3. Use an LLM to generate an image of a non-existing person. Make sure you inspect the image closely and get one that doesn’t have any obvious flaws.
...
7. Buy a Mint Mobile SIM card. You can find them in various places online and in stores near you, but you can get one of them on Amazon
